# executor-alter-table-add-column Specification

## Purpose
TBD - created by archiving change fix-v312-72-issue-4647-alter-table-add-column. Update Purpose after archive.
## Requirements
