#!/usr/bin/env python3
"""Generate TPC-H SF=0.01 fixture data for tests/data/tpch-sf01/.

Scale factors:
- SF=0.01 (SF01): ~1-10 MB total
  region=5, nation=25, supplier=100, customer=1500, part=2000,
  partsupp=8000, orders=1500, lineitem=6015
...
# SF=0.01 row counts (standard TPC-H scale factor)
ROW_COUNTS = {
    "region": 5,
    "nation": 25,
    "supplier": 100,
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Generate TPC-H SF=0.01 fixture .tbl data")
    ap.add_argument("--output", required=True, help="Output directory (e.g., tests/data/tpch-sf01)")
    ...
    print(f"=== TPC-H SF=0.01 fixture generator (seed={args.seed}) ===")
