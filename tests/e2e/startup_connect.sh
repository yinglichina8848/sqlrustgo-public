#!/usr/bin/env bash
# RC E2E scenario: startup_connect
# Connect to sqlrustgo via mysql client, verify server accepts connections,
# create a table, insert/select a row, drop the test DB.
set -euo pipefail
