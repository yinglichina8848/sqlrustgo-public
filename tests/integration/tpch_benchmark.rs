...
mod tests {
    ...
    fn setup_sqlrustgo_test_data() -> ExecutionEngine<MemoryStorage> {
        ...
        engine.execute("CREATE TABLE orders (o_orderkey INTEGER PRIMARY KEY, o_custkey INTEGER, o_orderstatus TEXT, o_totalprice REAL, o_orderdate TEXT, o_orderpriority TEXT, o_clerk TEXT, o_shippriority INTEGER, o_comment TEXT)").unwrap();
        engine.execute("CREATE TABLE customer (c_custkey INTEGER PRIMARY KEY, c_name TEXT, c_address TEXT, c_nationkey INTEGER, c_phone TEXT, c_acctbal REAL, c_mktsegment TEXT, c_comment TEXT)").unwrap();

        engine.execute("INSERT INTO lineitem VALUES (1, 100, 1000, 1, 15, 15000.00, 0.05, 1.2, 'N', 'O', '2024-01-01', '2024-01-02', '2024-01-03', 'NONE', 'AIR', 'comment1')").unwrap();
        engine.execute("INSERT INTO lineitem VALUES (1, 101, 1001, 2, 20, 20000.00, 0.05, 1.6, 'N', 'O', '2024-01-01', '2024-01-02', '2024-01-03', 'NONE', 'AIR', 'comment2')").unwrap();
        engine.execute("INSERT INTO lineitem VALUES (2, 102, 1002, 1, 5, 5000.00, 0.10, 0.4, 'N', 'O', '2024-01-02', '2024-01-03', '2024-01-04', 'NONE', 'TRUCK', 'comment3')").unwrap();
        engine.execute("INSERT INTO lineitem VALUES (3, 103, 1003, 1, 8, 8000.00, 0.08, 0.64, 'N', 'O', '2024-01-03', '2024-01-04', '2024-01-05', 'NONE', 'RAIL', 'comment4')").unwrap();
        engine.execute("INSERT INTO lineitem VALUES (3, 104, 1004, 1, 25, 25000.00, 0.03, 2.0, 'A', 'F', '2024-01-03', '2024-01-04', '2024-01-05', 'NONE', 'AIR', 'comment5')").unwrap();

        engine.execute("INSERT INTO orders VALUES (1, 1, 'O', 15000.00, '2024-01-01', '1-URGENT', 'Clerk#001', 0, 'comment')").unwrap();
        engine.execute("INSERT INTO orders VALUES (2, 2, 'O', 5000.00, '2024-01-02', '5-LOW', 'Clerk#002', 0, 'comment')").unwrap();
        engine.execute("INSERT INTO orders VALUES (3, 3, 'O', 8000.00, '2024-01-03', '3-MEDIUM', 'Clerk#003', 0, 'comment')").unwrap();
        engine.execute("INSERT INTO orders VALUES (4, 1, 'O', 25000.00, '2024-01-03', '1-URGENT', 'Clerk#001', 0, 'comment')").unwrap();
        engine.execute("INSERT INTO orders VALUES (5, 2, 'F', 3000.00, '2024-01-04', '2-HIGH', 'Clerk#002', 0, 'comment')").unwrap();

        engine.execute("INSERT INTO customer VALUES (1, 'Customer#00001', 'Address1', 1, '10-1111111', 1000.00, 'AUTOMOBILE', 'comment1')").unwrap();
        engine.execute("INSERT INTO customer VALUES (2, 'Customer#00002', 'Address2', 2, '10-2222222', 2000.00, 'BUILDING', 'comment2')").unwrap();
        engine.execute("INSERT INTO customer VALUES (3, 'Customer#00003', 'Address3', 1, '10-3333333', 3000.00, 'AUTOMOBILE', 'comment3')").unwrap();
        engine.execute("INSERT INTO customer VALUES (4, 'Customer#00004', 'Address4', 1, '10-4444444', 4000.00, 'FURNITURE', 'comment4')").unwrap();
        engine.execute("INSERT INTO customer VALUES (5, 'Customer#00005', 'Address5', 2, '10-5555555', 5000.00, 'MACHINERY', 'comment5')").unwrap();
