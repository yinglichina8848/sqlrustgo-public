...
fn q17_correlated_avg_filter_is_applied_before_aggregation() {
    ...
    e.execute("INSERT INTO lineitem VALUES (1, 1, 10.0, '1994-01-01')").unwrap();
    e.execute("INSERT INTO lineitem VALUES (1, 2, 20.0, '1994-01-01')").unwrap();
    e.execute("INSERT INTO lineitem VALUES (1, 100, 100.0, '1994-01-01')").unwrap();
    e.execute("INSERT INTO lineitem VALUES (1, 200, 200.0, '1994-01-01')").unwrap();
...
fn q20_scalar_sum_respects_supplier_and_date_filters() {
    ...
    for (suppkey, quantity) in [(1, 10), (1, 20), (1, 100), (2, 10), (2, 20), (2, 100)] {
        e.execute(&format!("INSERT INTO lineitem VALUES (10, {suppkey}, {quantity}, '1994-01-01')")).unwrap();
    }
