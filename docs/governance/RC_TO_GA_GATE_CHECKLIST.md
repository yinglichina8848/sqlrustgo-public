...
| oo/README.md 用户指南索引 | 用户指南链接完整 | ⏳ | | | |
| 用户文档版本状态 | 版本状态与发布状态一致 | ⏳ | | | |

**用户文档检查脚本**:
```bash
bash scripts/gate/check_user_guides.sh vX.Y.Z
```
...
| 最后更新 | 2026-04-22 |
| 负责人 | @yinglichina8848 |
| 适用版本 | SQLRustGo v2.7.0+ |
| 更新说明 | 添加用户指南检查项 (v2.7.0+ 要求) |
