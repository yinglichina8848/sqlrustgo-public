...
| 文档 | 说明 |
|:-----|:-----|
| PLUGIN_ARCHITECTURE.md | 完整插件化执行架构图 |
...
| 文档 | 说明 |
|:-----|:-----|
| L3_UPGRADE_PLAN.md | L2 → L3 升级详细计划 |
| ARCHITECTURE_REFACTORING.md | 模块边界重构建议 |
| TECH_DEBT_ANALYSIS.md | 技术债风险分析报告 |
| ARCHITECTURE_RISK_MODEL.md | 架构风险评分模型 |
| REFACTORING_PRIORITY.md | 模块重构优先级排序 |
