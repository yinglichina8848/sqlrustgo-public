---- MODULE PROOF_026_write_skew_TTrace_1777801819 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_026_write_skew_TTrace_1777801819.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_026_write_skew_TTrace_1777801819.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PROOF_026_write_skew_TTrace_1777801819 ----
CONSTANTS
    T1 = "T1"
    T2 = "T2"
    A = "A"
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun May 03 17:50:20 CST 2026