---- MODULE PROOF_023_deadlock_toctou_TTrace_1777896041 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_023_deadlock_toctou_TTrace_1777896041.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_023_deadlock_toctou_TTrace_1777896041.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PROOF_023_deadlock_toctou_TTrace_1777896041 ----
CONSTANTS
    Txns = { "T1" , "T2" }
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon May 04 20:00:42 CST 2026