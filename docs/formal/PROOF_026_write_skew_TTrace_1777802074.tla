---- MODULE PROOF_026_write_skew_TTrace_1777802074 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_026_write_skew_TTrace_1777802074.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_026_write_skew_TTrace_1777802074.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PROOF_026_write_skew_TTrace_1777802074 ----
CONSTANTS
    T1 = "T1"
    T2 = "T2"
    A = "A"
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun May 03 17:54:35 CST 2026