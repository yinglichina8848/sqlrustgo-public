---- MODULE PROOF_016_023_mvcc_toctou_TTrace_1777895418 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_016_023_mvcc_toctou_TTrace_1777895418.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_016_023_mvcc_toctou_TTrace_1777895418.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PROOF_016_023_mvcc_toctou_TTrace_1777895418 ----
CONSTANTS
    Txns = { "T1" , "T2" }
    Keys = { "K1" }
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon May 04 19:50:19 CST 2026