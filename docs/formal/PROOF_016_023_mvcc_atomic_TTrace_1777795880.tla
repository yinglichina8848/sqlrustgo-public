---- MODULE PROOF_016_023_mvcc_atomic_TTrace_1777795880 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_016_023_mvcc_atomic_TTrace_1777795880.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_016_023_mvcc_atomic_TTrace_1777795880.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PROOF_016_023_mvcc_atomic_TTrace_1777795880 ----
CONSTANTS
    Txns = { "T1" , "T2" }
    Keys = { "K1" }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun May 03 16:11:21 CST 2026