---- MODULE PROOF_023_deadlock_toctou_TTrace_1777903556 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_023_deadlock_toctou_TTrace_1777903556.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_023_deadlock_toctou_TTrace_1777903556.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PROOF_023_deadlock_toctou_TTrace_1777903556 ----
CONSTANTS
    Txns = { "T1" , "T2" }
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon May 04 22:05:57 CST 2026