---- MODULE PROOF_023_deadlock_toctou_TTrace_1777898152 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_023_deadlock_toctou_TTrace_1777898152.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_023_deadlock_toctou_TTrace_1777898152.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PROOF_023_deadlock_toctou_TTrace_1777898152 ----
CONSTANTS
    Txns = { "T1" , "T2" }
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon May 04 20:35:53 CST 2026