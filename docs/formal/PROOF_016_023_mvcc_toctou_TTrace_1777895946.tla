---- MODULE PROOF_016_023_mvcc_toctou_TTrace_1777895946 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_016_023_mvcc_toctou_TTrace_1777895946.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_016_023_mvcc_toctou_TTrace_1777895946.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PROOF_016_023_mvcc_toctou_TTrace_1777895946 ----
CONSTANTS
    Txns = { "T1" , "T2" }
    Keys = { "K1" }
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon May 04 19:59:07 CST 2026