...
| 15 | `sqlrustgo-executor` | 76.45% | 13060/16136 | 78.69% | 1436/1659 | ✅ | ❌ | lib 仅 |
| 16 | `sqlrustgo-spill` | 75.17% | 725/905 | 76.36% | 110/136 | ✅ | ❌ | 全量测试 |
| 17 | `sqlrustgo-sql-corpus` | 75.16% | 914/1141 | 54.43% | 79/115 | ✅ | ❌ | 全量测试 |
| 18 | `sqlrustgo-gmp` | 73.54% | 3088/4200 | 66.45% | 310/414 | ❌ | ❌ | 全量测试 |
| 19 | `sqlrustgo-parser` | 71.22% | 9522/12262 | 89.66% | 706/779 | ❌ | ❌ | 全量测试 |
| 20 | `sqlrustgo-tools` | 63.84% | 1626/2214 | 75.51% | 147/183 | ❌ | ❌ | 全量测试 |
| 21 | `sqlrustgo-mysql-server` | 51.53% | 3650/5419 | 61.35% | 326/432 | ❌ | ❌ | 全量测试 |
| 22 | `sqlrustgo-bench` | 57.85% | 2109/2998 | 57.45% | 369/526 | ❌ | ❌ | lib (跳慢测) |
| 23 | `sqlrustgo-mysql-client` | 43.79% | 507/792 | 61.54% | 26/36 | ❌ | ❌ | 全量测试 |
| 24 | `sqlrustgo-soak` | 4.89% | 716/1397 | 9.30% | 43/82 | ❌ | ❌ | 全量测试 |
| 25 | `sqlrustgo-cli` | 0.00% | 186/372 | 0.00% | 10/20 | ❌ | ❌ | 全量测试 |
| 26 | `sqlrustgo` | 17.00% | 6958/12733 | 18.74% | 587/1064 | ❌ | ❌ | lib (跳慢测) |
| 27 | `sqlrustgo-server` | 85.00% | 1220/1435 | 78.65% | 178/216 | ✅ | ✅ | 全量测试 |
...
|------|----------|---|
| **≥90%** | **6** crates | |
|   `sqlrustgo-network` | 100.00% |
|   `sqlrustgo-cache` | 99.47% |
|   `sqlrustgo-wal-verification` | 97.20% |
|   `sqlrustgo-telemetry` | 96.67% |
|   `sqlrustgo-rag` | 96.58% |
|   `sqlrustgo-types` | 91.16% |
| **80-89%** | **7** crates | |
|   `sqlrustgo-common` | 89.17% |
|   `sqlrustgo-optimizer` | 88.23% |
|   `sqlrustgo-planner` | 84.91% |
|   `sqlrustgo-storage` | 85.58% |
|   `sqlrustgo-transaction` | 84.29% |
|   `sqlrustgo-catalog` | 85.08% |
|   `sqlrustgo-admin` | 83.14% |
|   `sqlrustgo-security` | 82.67% |
|   `sqlrustgo-server` | 85.00% |
| **75-79%** | **3** crates | |
|   `sqlrustgo-executor` | 76.45% |
|   `sqlrustgo-spill` | 75.17% |
|   `sqlrustgo-sql-corpus` | 75.16% |
| **50-74%** | **5** crates | |
|   `sqlrustgo-gmp` | 73.54% |
|   `sqlrustgo-parser` | 71.22% |
|   `sqlrustgo-tools` | 63.84% |
|   `sqlrustgo-mysql-server` | 51.53% |
|   `sqlrustgo-bench` | 57.85% |
| **<50%** | **4** crates | |
...
sqlrustgo-vector                          N/A      N/A       N/A       N/A (timeout)
---------------------------------------------------------------------------
