...
> - `v1.2.0-draft` 为历史阶段记录，保留用于追溯，不代表当前阶段
...
| 问题类型 | 数量 | 阻塞程度 | 负责人 | 状态 |
|----------|------|----------|--------|------|
| Clippy 错误 | 15 | 🔴 阻塞 | maintainer | 待修复 |
| 测试编译错误 | 1 | 🔴 阻塞 | maintainer | 待修复 |
...
| 接口 | 状态 | v2.0 扩展方向 |
|------|------|--------------|
| StorageEngine | ✅ 已抽象 | 分布式存储 (Sharding) |
| RecordBatch | ✅ 已抽象 | 网络传输序列化 |
| CostModel | ✅ 已抽象 | 网络成本计算 |
| Memo | ✅ 已抽象 | 分布式优化 |
| Operator | ✅ 已抽象 | 远程执行转换 |
