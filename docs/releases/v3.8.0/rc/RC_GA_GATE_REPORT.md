...
**Delta (vs v3.7.0)**: +0 ACTIVE, +0 CLOSED, +0 DEFERRED

**Verdict**: ⚠️ **NEEDS_ATTENTION** — 11 ACTIVE debt, 0 progress this release

**Per ADR-010 Decision-3**:
- ACTIVE 跨 3 个版本 → P0 升级
- ACTIVE 跨 5 个版本 → GA 阻断
- 当前 INT-1 跨 7 版本 (v1.2.0 ~ v3.8.0) — 已达 GA 阻断阈值

**Action Item**: 11 ACTIVE debt 需在 v3.8.0+1 / v3.9.0 制定修复计划（详见 `docs/releases/v3.8.0/CROSS-VERSION-DEBT.md`）
