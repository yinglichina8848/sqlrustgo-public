...
| F-24 | 自适应哈希索引 (AHI) | v2.5.0 | ❌ 未实现 | ❌ DEFERRED to v3.9.0 | |
| F-25 | Change Buffer | v2.5.0 | ⚠️ 部分 | ❌ DEFERRED | |
| F-26 | 双写缓冲 | v2.5.0 | ❌ 未实现 | ❌ DEFERRED | |
...
| T-19 | Disk I/O delay simulation | ❌ 无 | ❌ DEFERRED |
