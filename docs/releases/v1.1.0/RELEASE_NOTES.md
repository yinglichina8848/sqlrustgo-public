...
| 模块 | 变更 | 说明 |
|------|------|------|
|__代码0__| 新增 |LogicalPlan/PhysicalPlan 模块|
|__代码0__| 重构 |ExecutionEngine trait 插件化|
|__代码0__| 新增 |Client-Server 网络层|
|__代码0__| 扩展 |Hash trait 实现|

### 配置变更

| 配置项 | 默认值 | 说明 |
|--------|--------|------|
|__代码0__| "0.0.0.0:3306" | 服务器绑定地址 |
|__代码0__| 100 | 最大连接数 |
...
- @yinglichina8848
- @openheart-opencode（BRING AI 助手）
