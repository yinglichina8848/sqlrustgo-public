...
| Surface | Owner | Expiry | Follow-up Issue | 说明 |
|---------|-------|--------|-----------------|------|
| empty_password_auth | openclaw | 2027-06-30 | TBD | 空密码认证边界测试需要 fixture 实现 |
| prepared_stmt_roundtrip | openclaw | 2027-06-30 | TBD | 预处理语句协议问题需要修复 |
| timestamp_timezone_deferred | openclaw | 2027-06-30 | TBD | TIMESTAMP 类型时区支持 |
| connection_pool_deferred | openclaw | 2027-06-30 | TBD | 连接池实现 |
| alter_change_full_syntax_deferred | openclaw | 2027-06-30 | TBD | ALTER TABLE CHANGE 完整语法 |
| median_unsupported | openclaw | 2027-06-30 | TBD | MEDIAN 聚合函数实现 (返回 NULL 而非错误) |
| window_rank_partition_unsupported | openclaw | 2027-06-30 | TBD | 窗口函数 RANK OVER PARTITION BY wire protocol truncation |
