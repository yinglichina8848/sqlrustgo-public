...
> **provenance:** generated_by=check_docs_links_v312.sh, generated_at=2026-09-02T13:13:55Z, commit=da7633827dfd3b17d626d37a4b77a0f05e5a7f08, branch=fix/v312-59-D-execute-delete-fast-path, source_repo=openclaw/sqlrustgo, gate_policy_eval_id=v312-ga7-docs-links-001, policy=Anti-Fabrication-Policy-v1.0
...
| Check | Status |
|-------|--------|
| v3.12.0 file existence | PASS |
| Relative link verification | PASS |
| General docs links (entry) | see log |

**Verdict: PASS** — 0 broken links across v3.12.0 doc scope
