...
> **head_at_sync:** `ca5649d424` (develop/v3.12.0, post PR #4561 merge — superseded by this PR; F-5 fmt closed via PR #4562 #55b9bc9cc). **Corrected GA-2 row** is in this PR's commit; the merged PR #4561 GA-2 row contained a technically incorrect claim refuted by `crates/mysql-server/src/lib.rs:4791/4980/5101/5110` (COM_STMT_PREPARE/EXECUTE/CLOSE/COM_RESET_CONNECTION handlers all present). See PR comments 98304 and 98323 for the full review.
