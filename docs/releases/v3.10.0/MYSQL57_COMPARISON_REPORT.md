...
## 6. v3.10.0 Post-GA Updates (2026-07-14)

### 6.1 并行执行器优化 (Issue #3792)

v3.10.0 GA 实施的 6 项并行优化已实测有效:

| Query 类型 | 加速比 (4 线程) |
|-----------|:---:|
| 聚合 (Q1) | **1.27x** @ SF=1.0 |
| 3-way join (Q3) | **1.08x** @ SF=1.0/3.0 |
| 6-way join (Q5) | **1.10x** @ SF=1.0/3.0 |
| 相关子查询 (Q4) | 1.00x (受 naive nested-loop 限制, v3.11+ Hash Semi Join) |
