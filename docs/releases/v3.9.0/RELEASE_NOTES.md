<!-- 2026-07-10 GA CUT addendum (auto-applied) -->
> **状态更新**: v3.9.0 GA CUT 已于 2026-07-10 在 commit `184ad102e9` 完成。
> - Tag `v3.9.0` 已创建并推送至 252 remote
> - 72h SOAK 完成 (119h57m, 0 错误, Issue #3265 已关闭)
> - 168h SOAK 进行中 (ETA 2026-07-12 22:02, Issue #3266)
> - G3/G4 conditional 已获 Hermes C 授权
> - `ga/GA_RELEASE_NOTES.md` 已创建
>
