...
| 版本 | 状态 | 说明 |
|:-----|:-----|:-----|
| v1.0.0 | 🔄 正式发布中 | Alpha阶段：测试覆盖率提升，目标 90%+ |
| v1.0.1 | 🔜 规划中 | 错误修正 + CI 完善 + 文档补全 |
| v1.1.0 | 🔜 规划中 | 聚合函数, ORDER BY, LIMIT |
...
当前状态 (测试覆盖 60-70%)
    ↓
v1.0.0 Alpha (测试覆盖 >= 90%) ← 当前进行中
    ↓
v1.0.0 Beta (CI完善 + 文档完整)
    ↓
v1.0.0 Release (基准测试 + 安全扫描) ← 正式发布
```
...
| 阶段 | 任务 | 状态 | 优先级 |
|:-----|:-----|:-----|:-------|
| **Alpha** | 测试覆盖率提升到 90%+ | 🔄 进行中 | P0 |
| Alpha | 所有测试通过 | ⏳ 待验证 | P0 |
| Alpha | clippy 无警告 | ⏳ 待验证 | P0 |
| **Beta** | CI 流水线完善 | ⏳ 待开始 | P1 |
| Beta | API 文档补全 | ⏳ 待开始 | P1 |
| Beta | CHANGELOG 生成 | ⏳ 待开始 | P1 |
| **Release** | 基准测试通过 | ⏳ 待开始 | P2 |
| Release | 版本标签创建 | ⏳ 待开始 | P2 |
| Release | GitHub Release 发布 | ⏳ 待开始 | P2 |
