...
- ✅ **保留策略 (Retention Policy)** - 自动清理旧备份，支持按数量和天数保留
...
```
Physical backup retention policy:
================================================================================
  Keep: 3 most recent backup(s)
  Mode: DRY RUN (no changes)

Backup(s) to delete (2 total, 2097152 bytes):
  ❌ backup_20260328 - 2026-03-28_12:00:00 (1048576 bytes)
  ❌ backup_20260327 - 2026-03-27_12:00:00 (1048576 bytes)

Backup(s) to keep (3 total):
  ✅ backup_20260401 - 2026-04-01_12:00:00 (1048576 bytes)
  ✅ backup_20260331 - 2026-03-31_12:00:00 (1048576 bytes)
  ✅ backup_20260330 - 2026-03-30_12:00:00 (1048576 bytes)
...
test physical_backup::tests::test_is_leap_year ... ok
test physical_backup::tests::test_days_since_epoch ... ok
test physical_backup::tests::test_parse_timestamp_to_epoch ... ok
test physical_backup::tests::test_calculate_backup_size ... ok
test physical_backup::tests::test_calculate_backup_size_empty_dir ... ok
test physical_backup::tests::test_physical_backup_command_prune_variants ... ok
