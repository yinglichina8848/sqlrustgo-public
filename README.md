...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v1.6.0--GA-blue" alt="Version">
  <img src="https://img.shields.io/badge/branch-release%2Fv1.6.0-green" alt="Branch">
...
|------|--------|
| 当前版本状态 | **v1.6.0 GA** |
| 当前发布分支 | **release/v1.6.0** |
| 当前阶段 | GA (正式发布) |
| 上一稳定版本 | v1.5.0 |

- 版本文件: [VERSION](VERSION)
- 当前版本说明: [docs/releases/v1.6.0/RELEASE_NOTES.md](docs/releases/v1.6.0/RELEASE_NOTES.md)
- v1.6.0 文档入口: [docs/releases/v1.6.0/README.md](docs/releases/v1.6.0/README.md)
