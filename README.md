...
放了寒假，本来是用笔记本工作的，但是笔记本屏幕，很感人啊，所以啊，你们懂的，5K 屏幕就接上 华为 MateBookX 了，男人吗，也要对自己好点，有东西不用是浪费啊，老婆全套的苹果，一体机，BookAir，iPad，手机，甚至 iPod，Kindle，Watch 都有。显示器放着，macmini 没人用，真浪费。最早 5K 显示器是笔记本的副屏。后来，后来不是龙虾来了吗。说的很邪乎，啥删光文件，格式化系统，我可不敢在 工作的笔记本上整，干脆就 mini 吧，结果一用，就停不下来喽。特么比 Windows，Ubuntu 好用太多了。这玩意是一帮子不差钱，最挑剔的艺术家搞出来的系统，能不好用吗？
...
- **[文档阅读指南](docs/文档阅读指南.md)** - 项目文档结构和阅读路径指南
- **[项目演进说明](docs/项目演进说明.md)** - 从零开始的 AI 协作开发完整流程

### v1.0 文档

- **[v1.0 目录](docs/v1.0/README.md)** - v1.0 版本文档索引
- [架构设计](docs/architecture.md)
- [Alpha 阶段目标](docs/v1.0/alpha/README.md)
- [评估改进报告](docs/v1.0/评估改进/综合改进计划.md)

### v2.0 规划

- **[v2.0 目录](docs/v2.0/README.md)** - v2.0 架构规划索引
- **[2.0 白皮书](docs/v2.0/WHITEPAPER.md)** - SQLRustGo 2.0 架构愿景
- **[TRAE-2.0对话记录](docs/v2.0/TRAE-2.0对话记录.md)** - 2.0 架构规划对话

### 对话记录

项目开发过程的真实记录，展示 AI 辅助开发的完整流程：

- **[TRAE-文档改进和补全对话](docs/TRAE-文档改进和补全对话.md)** - 文档分析、组织和 AI 方法论
- **[对话记录](docs/v1.0/对话记录.md)** - 项目创建过程中的关键对话
- **[飞书群聊记录](docs/v1.0/飞书-龙虾群聊记录.md)** - 多 Agent 协作的实时沟通记录
