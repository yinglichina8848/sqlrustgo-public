...
use sqlrustgo_storage::{binary_storage::BinaryTableStorage, FileStorage};
...
fn main() {
    ...
    println!("==============================================");
    println!(
        "Point Query (B+Tree): {:.0}x faster",
        scan_time.as_secs_f64() / index_time.as_secs_f64()
    );
    println!(
        "Full Table Scan: {:.0} rows/s",
