//! OLTP Update Index workload
//!
//! Sysbench-compatible update on indexed column
...
impl Default for OltpUpdateIndex {
    fn default() -> Self {
        Self::new()
    }
}
...
#[async_trait]
impl crate::workload::Workload for OltpUpdateIndex {
